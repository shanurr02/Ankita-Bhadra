...
export const REELS: Reel[] = [
  {
    ...
    collaboratorHandle: 'imperialcoachingcentre and __bhadra___',
...

  {
    ...
    creatorHandle: '__bhadra___',
    collaboratorHandle: 'studynextofficial and __bhadra___',
...

  {
    ...
    creatorHandle: '__bhadra___',
    collaboratorHandle: 'nykaabeauty and __bhadra___',
...
export const SERVICES: Service[] = [
  {
    ...
    subtitle: 'High-retention storytelling built for algorithmic reach',
    description:
...

  {
    ...
    subtitle: 'Commanding stage presence for corporate summits & awards',
    description:
...

  {
    ...
    subtitle: 'Building authentic buyer trust with candid walkthroughs',
    description:
...

  {
    ...
    subtitle: 'Consistent, authentic brand voice over multi-month campaigns',
    description:
